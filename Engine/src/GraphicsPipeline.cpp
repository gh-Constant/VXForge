...
namespace VXForge {
    ...
    void VXForgeGraphicsPipeline::createGraphicsPipeline(const std::string& shaderName, const PipelineConfigInfo& configInfo) {
        ...
        auto bindingDescriptions = VXForgeModel::Vertex::getBindingDescriptions();
        auto attributeDescriptions = VXForgeModel::Vertex::getAttributeDescriptions();
    ...
    void VXForgeGraphicsPipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo) {
